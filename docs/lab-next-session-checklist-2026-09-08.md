...
> **2026-09-09 暂停通知：现场出现 stop_move 超时及停止后异常位置变化，
> 本文 P/A/B 动作安排暂停，不能继续按旧清单执行。参见
> [停止异常调查与复测限制](real-robot-stop-investigation-2026-09-09.md)。
> 新增停止判定与日志不等于异常位移已解决，也不构成真机运动放行。**
